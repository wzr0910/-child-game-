// EdgeOne Makers（国内版 console.cloud.tencent.com/edgeone/makers）
// 的 Cloud Functions 入口。约定目录：项目根下的 /cloud-functions/，
// 文件路径 /cloud-functions/api/gallery.js 自动对应 URL /api/gallery。
// 导出必须是默认的 onRequest(context) 函数（不是 onRequestPost，与 Vercel 不一样）。
